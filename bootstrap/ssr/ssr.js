...
import { Fragment as Fragment$1, useCallback, useEffect, useId, useRef, useState } from 'react';
...
function InputError({ message, className = '', ...props }) {
    return message
        ? /* @__PURE__ */ jsx('p', { ...props, className: cn('text-sm text-red-600 dark:text-red-400', className), children: message })
        : null;
}
                            ...
                            /* @__PURE__ */ jsxs(Link, {
                                ...
                                children: [
                                    /* @__PURE__ */ jsx('div', {
                                        ...
                                        children: /* @__PURE__ */ jsx(AppLogoIcon, {
        ...
        children: [
            ...
            /* @__PURE__ */ jsxs('div', {
                ...
                children: [
                    ...
                    /* @__PURE__ */ jsxs('div', {
                        className: 'text-muted-foreground space-x-1 text-center text-sm',
                        children: [
...
const Checkbox = React.forwardRef(({ className, ...props }, ref) =>
    /* @__PURE__ */ jsx(CheckboxPrimitive.Root, {
        ref,
        className: cn(
            'peer border-input ring-offset-background focus-visible:ring-ring data-[state=checked]:bg-primary data-[state=checked]:text-primary-foreground data-[state=checked]:border-accent-foreground size-5 shrink-0 rounded-sm border focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-hidden disabled:cursor-not-allowed disabled:opacity-50',
            className,
        ),
        ...props,
        children: /* @__PURE__ */ jsx(CheckboxPrimitive.Indicator, {
            className: cn('flex items-center justify-center text-current'),
            children: /* @__PURE__ */ jsx(Check, { className: 'size-3.5 stroke-[3]' }),
        }),
    }),
);
        ...
        children: [
            /* @__PURE__ */ jsx('defs', {
                children: /* @__PURE__ */ jsx('pattern', {
                    ...
                    children: /* @__PURE__ */ jsx('path', { d: 'M-1 5L5 -1M3 9L8.5 3.5', 'stroke-width': '0.5' }),
                }),
            }),
            ...
            /* @__PURE__ */ jsxs(SheetPrimitive.Content, {
                ...
                children: [
                    ...
                    /* @__PURE__ */ jsxs(SheetPrimitive.Close, {
                        className:
                            'absolute right-6 top-6 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary',
                        children: [
...
const SheetTitle = React.forwardRef(({ className, ...props }, ref) =>
    /* @__PURE__ */ jsx(SheetPrimitive.Title, { ref, className: cn('text-foreground text-lg font-semibold', className), ...props }),
);
SheetTitle.displayName = SheetPrimitive.Title.displayName;
const SheetDescription = React.forwardRef(({ className, ...props }, ref) =>
    /* @__PURE__ */ jsx(SheetPrimitive.Description, { ref, className: cn('text-muted-foreground text-sm', className), ...props }),
);
SheetDescription.displayName = SheetPrimitive.Description.displayName;
function Skeleton({ className, ...props }) {
    return /* @__PURE__ */ jsx('div', { className: cn('bg-muted animate-pulse rounded-md', className), ...props });
}
...
const SidebarSeparator = React.forwardRef(({ className, ...props }, ref) => {
    return /* @__PURE__ */ jsx(Separator, { ref, 'data-sidebar': 'separator', className: cn('bg-sidebar-border mx-2 w-auto', className), ...props });
});
...
const DropdownMenuSeparator = React.forwardRef(({ className, ...props }, ref) =>
    /* @__PURE__ */ jsx(DropdownMenuPrimitive.Separator, { ref, className: cn('bg-muted -mx-1 my-1 h-px', className), ...props }),
);
        ...
        children: [
            /* @__PURE__ */ jsx(DropdownMenuLabel, {
                ...
                children: /* @__PURE__ */ jsx('div', {
                    ...
                    children: /* @__PURE__ */ jsx(UserInfo, { user, showEmail: true }),
                }),
            }),
    ...
    return /* @__PURE__ */ jsxs(Fragment, {
        children: [
            ...
            /* @__PURE__ */ jsx('div', {
                ...
                children: /* @__PURE__ */ jsx('span', { className: 'mb-0.5 truncate leading-none font-semibold', children: 'Laravel Starter Kit' }),
            }),
        ],
    });
}
                ...
                children: /* @__PURE__ */ jsx(SidebarMenu, {
                    children: /* @__PURE__ */ jsx(SidebarMenuItem, {
                        children: /* @__PURE__ */ jsx(SidebarMenuButton, {
                            size: 'lg',
                            asChild: true,
                            children: /* @__PURE__ */ jsx(Link, { href: '/dashboard', prefetch: true, children: /* @__PURE__ */ jsx(AppLogo, {}) }),
                        }),
                    }),
                }),
            }),
...
function AppSidebarHeader({ breadcrumbs: breadcrumbs2 = [] }) {
    return /* @__PURE__ */ jsx('header', {
        ...
        children: /* @__PURE__ */ jsxs('div', {
            ...
            children: [/* @__PURE__ */ jsx(SidebarTrigger, { className: '-ml-1' }), /* @__PURE__ */ jsx(Breadcrumbs, { breadcrumbs: breadcrumbs2 })],
        }),
    });
}
    ...
    return /* @__PURE__ */ jsxs(AppShell, {
        ...
        children: [
            ...
            /* @__PURE__ */ jsxs(AppContent, {
                variant: 'sidebar',
                children: [/* @__PURE__ */ jsx(AppSidebarHeader, { breadcrumbs: breadcrumbs2 }), children],
            }),
        ],
    });
}
const AppLayout = ({ children, breadcrumbs: breadcrumbs2, ...props }) =>
    /* @__PURE__ */ jsx(AppSidebarLayout, { breadcrumbs: breadcrumbs2, ...props, children });
const breadcrumbs$3 = [
    {
        title: 'Dashboard',
        href: '/dashboard',
                    ...
                    /* @__PURE__ */ jsxs('div', {
                        ...
                        children: [
                            /* @__PURE__ */ jsx('div', {
                                ...
                                children: /* @__PURE__ */ jsx(PlaceholderPattern, {
...
function AppearanceToggleTab({ className = '', ...props }) {
    ...
    return /* @__PURE__ */ jsx('div', {
        ...
        ...props,
        children: tabs.map(({ value, icon: Icon2, label }) =>
            /* @__PURE__ */ jsxs(
                'button',
                {
...
const DialogTitle = React.forwardRef(({ className, ...props }, ref) =>
    /* @__PURE__ */ jsx(SheetPrimitive.Title, { ref, className: cn('text-lg leading-none font-semibold tracking-tight', className), ...props }),
);
                                                ...
                                                /* @__PURE__ */ jsxs('p', {
                                                    ...
                                                    children: [
                                                        ...
                                                        /* @__PURE__ */ jsx(Link, {
                                                            ...
                                                            as: 'button',
                                                            className:
                                                                'rounded-md text-sm text-neutral-600 underline hover:text-neutral-900 focus:ring-2 focus:ring-offset-2 focus:outline-hidden',
                        ...
                        children: /* @__PURE__ */ jsx('nav', {
                            ...
                            children: auth.user
                                ? /* @__PURE__ */ jsx(Link, {
                                      ...
                                      className:
                                          'inline-block rounded-sm border border-[#19140035] px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]',
                                      children: 'Dashboard',
                                  })
                    ...
                    /* @__PURE__ */ jsx('div', {
                        ...
                        children: /* @__PURE__ */ jsxs('main', {
                            ...
                            children: [
                                /* @__PURE__ */ jsxs('div', {
                                    className:
                                        'flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]',
                                    children: [
                                        ...
                                        /* @__PURE__ */ jsxs('ul', {
                                            ...
                                            children: [
                                                    ...
                                                    children: [
                                                        /* @__PURE__ */ jsx('span', {
                                                            ...
                                                            children: /* @__PURE__ */ jsx('span', {
                                                                className:
                                                                    'flex h-3.5 w-3.5 items-center justify-center rounded-full border border-[#e3e3e0] bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-[#3E3E3A] dark:bg-[#161615]',
                                                                children: /* @__PURE__ */ jsx('span', {
                                                                    className: 'h-1.5 w-1.5 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]',
                                                                }),
                                                            }),
                                                        }),
                                                        /* @__PURE__ */ jsxs('span', {
                                                            children: [
                                                                ...
                                                                /* @__PURE__ */ jsxs('a', {
                                                                    ...
                                                                    target: '_blank',
                                                                    className:
                                                                        'ml-1 inline-flex items-center space-x-1 font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]',
                                                                    children: [
                                                ...
                                                /* @__PURE__ */ jsxs('li', {
                                                    className:
                                                        'relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]',
                                                    children: [
                                                        /* @__PURE__ */ jsx('span', {
                                                            className: 'relative bg-white py-1 dark:bg-[#161615]',
                                                            children: /* @__PURE__ */ jsx('span', {
                                        ...
                                        /* @__PURE__ */ jsx('ul', {
                                            ...
                                            children: /* @__PURE__ */ jsx('li', {
                                                children: /* @__PURE__ */ jsx('a', {
                                                    ...
                                                    target: '_blank',
                                                    className:
                                                        'inline-block rounded-sm border border-black bg-[#1b1b18] px-5 py-1.5 text-sm leading-normal text-white hover:border-black hover:bg-black dark:border-[#eeeeec] dark:bg-[#eeeeec] dark:text-[#1C1C1A] dark:hover:border-white dark:hover:bg-white',
                                                    children: 'Deploy now',
                                                }),
                                            }),
                                        }),
                                ...
                                /* @__PURE__ */ jsxs('div', {
                                    ...
                                    children: [
                                        /* @__PURE__ */ jsxs('svg', {
                                            className:
                                                'w-full max-w-none translate-y-0 text-[#F53003] opacity-100 transition-all duration-750 dark:text-[#F61500] starting:translate-y-6 starting:opacity-0',
                                            viewBox: '0 0 438 104',
                                            fill: 'none',
                                            xmlns: 'http://www.w3.org/2000/svg',
                                            children: [
                                        ...
                                        /* @__PURE__ */ jsxs('svg', {
                                            ...
                                            children: [
                                                /* @__PURE__ */ jsxs('g', {
                                                    className:
                                                        'translate-y-0 opacity-100 transition-all delay-300 duration-750 starting:translate-y-4 starting:opacity-0',
                                                    children: [
                                                        /* @__PURE__ */ jsx('path', {
                                        ...
                                        /* @__PURE__ */ jsx('div', {
                                            className:
                                                'absolute inset-0 rounded-t-lg shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-t-none lg:rounded-r-lg dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]',
                                        }),
                                    ],
                                }),
                            ],
